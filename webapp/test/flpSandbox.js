		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#bpmaint28bpmaint28-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bpmaint28bpmaint28-display": {
								"semanticObject": "bpmaint28bpmaint28",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bpmaint28.bpmaint28",
									"url": sap.ui.require.toUrl("bpmaint28/bpmaint28")
								}
							}
						}
					}
